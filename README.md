...
Bookings require `customerEmail` and `bookedDay` values, and allow the same seat on different days while rejecting duplicate active bookings for the same seat and day:
